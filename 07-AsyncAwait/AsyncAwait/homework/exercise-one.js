...
async function problemA() {
  ...
  var result = await promisifiedReadFile("poem-one/stanza-01.txt");
  blue(result);
}
...
async function problemB() {
  ...
  // AsyncAwait version
  var result = await promisifiedReadFile("poem-one/stanza-02.txt");

  var result2 = await promisifiedReadFile("poem-one/stanza-03.txt");
  blue(result);
  blue(result2);
}
...
async function problemD() {
  ...
  try {
    var result = await promisifiedReadFile("poem-one/stanza-04.txt");
    blue(result);
  } catch (error) {
    magenta(error)
  } 
...
async function problemE() {
  ...
  // AsyncAwait version
  try {
    var result = await promisifiedReadFile("poem-one/stanza-03.txt");
    var result2 = await promisifiedReadFile("poem-one/stanza-04.txt");
    blue(result);
    blue(result2);
  } catch (error) {
    magenta(error)
...
async function problemF() {
  ...
  try {
    var result = await promisifiedReadFile("poem-one/stanza-03.txt");
    var result2 = await promisifiedReadFile('poem-one/wrong-file-name.txt');
    blue(result);
    blue(result2);
  } catch (error) {
    magenta(error)
